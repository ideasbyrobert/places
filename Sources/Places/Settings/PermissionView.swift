            ...
            VStack(alignment: .leading, spacing: 8)
            {
                ...
                Text(
                    authorization.isTrusted
                        ? "Places can now move and arrange standard windows."
                        : "Open Privacy & Security. Choose Device Control and Data Access on this macOS version, or Accessibility on earlier versions. Enable Places.app itself, not a Tests-Runner app, then return. This window closes when macOS confirms access. Places does not read window titles, documents, general typing, or screen contents."
                )
